...
describe('InvoicesService', () => {
  ...
  describe('create', () => {
    it('should create an invoice with items', async () => {
      ...
      jest
        ...
        .mockResolvedValue({ id: 'inv-1', ...invoiceData } as any);
          ...
          data: expect.objectContaining({
            ...
            items: expect.objectContaining({
              create: expect.arrayContaining([
                expect.objectContaining({ itemName: 'Consultation' }),
              ]),
            }),
          }),
        }),
  ...
  describe('findOne', () => {
    ...
    it('should throw NotFoundException if not found', async () => {
      ...
      await expect(
        service.findOne('non-existent', mockOrgId, mockBranchId),
  ...
  describe('addPayment', () => {
    it('should create a payment record', async () => {
      ...
      jest
        ...
        .mockResolvedValue({ id: 'pay-1', ...paymentData } as any);
